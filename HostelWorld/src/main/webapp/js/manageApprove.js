$(function(){
    ...
    //获取content对象里面，数据的数量
    var number_of_items = $(".open-hotel-row").length;
    ...
    $(".open-hotel-row").slice(0, show_per_page).css('display', 'block');
    ...
    $("body").on("click","#pageGro li",function(){
        ...
        $(".open-hotel-row").css('display', 'none').slice(start_from, end_on).css('display', 'block');
        if(pageCount > 5){
            //显示页面
