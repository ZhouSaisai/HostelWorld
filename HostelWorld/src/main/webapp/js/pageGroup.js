$(function(){
	...
	$("body").on("click","#pageGro li",function(){
		...
		//开始
		start_from = pageNum * show_per_page+1;
		//结束
		end_on = start_from + show_per_page;
		//隐藏内容ul的所有子元素，获取特定项目并显示它们
		$('#cash-table').find("tr").css('display', 'none').slice(start_from, end_on).css('display', 'table-row');
	...
	$("#pageGro .pageUp").click(function(){
		...
		//开始
		start_from = page * show_per_page - show_per_page+1;
		//结束
		end_on = start_from + show_per_page;
	...
	$("#pageGro .pageDown").click(function(){
		...
		var show_per_page = parseInt($('#show_per_page').val());
		//开始
		start_from = page * show_per_page+1;
