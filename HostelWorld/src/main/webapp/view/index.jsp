    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="/HotelWorld/person_login">个人登录</a></li>
                <li><a href="/HotelWorld/hotel_login">客栈登录</a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div>
</nav>
    ...
    <div class="row" id="logReg">
        ...
        <div class="row">
            <div class="switch-buttons">
                <a class="switch-button" id="person" href="/HotelWorld/person_login">个人登录</a>
                <a class="switch-button" id="hotel" href="/HotelWorld/hotel_login">客栈登录</a>
            </div>
        </div>
    </div>
