...
//        }
//
//        public BaseDAOImpl.DmlHelper append(CharSequence dmlPart, Object... params) {
//            if (dmlPart != null) {
...
//        }
//
//        public BaseDAOImpl.DmlHelper addEqual(String fieldName, Object value, Object... nullVal) {
...
//        }
//
//        public BaseDAOImpl.DmlHelper addLikeAll(String name, String value) {
...
//         *            结果日期
//         */
//        public BaseDAOImpl.DmlHelper addDayRange(String fieldName, Date minDay, Date maxDay) {
...
//         *            结果时间
//         */
//        public BaseDAOImpl.DmlHelper addDayRange(String fieldName, String minTime, String maxTime) {
...
//         *            结果时间
//         */
//        public BaseDAOImpl.DmlHelper addTimeRange(String fieldName, Date minTime, Date maxTime) {
//            if (minTime != null) {
//                dmlCmd.append(" and ").append(fieldName).append(">? ");
